...
class FunctionsPrintFacts_20 {
   ...
   */
  public function printFactAndReturnScript(
          Fact $fact, 
          GedcomRecord $record) {
    ...
    echo FunctionsPrint_20::formatFactDate($fact, $record, true, true, ($fact->id() === 'asso'));
